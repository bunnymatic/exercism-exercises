...
defmodule MeetupTest do
  ...
  # test "numbered day of the week" do
  #   assert Meetup.numbered_day_of_week(:monday) == 1
  #   assert Meetup.numbered_day_of_week(:wednesday) == 3
  #   assert Meetup.numbered_day_of_week(:sunday) == 7
  # end
